<x-app-layout>
   <div class="min-h-screen flex flex-col sm:ml-64 bg-gray-100"> <!-- Restored gray background -->
      <div class="flex-grow p-4">
         <div class="p-4 space-y-8"> <!-- Added spacing between child elements -->

            <div class="bg-blue-100 border border-blue-300 rounded-lg p-6 shadow-lg"> <!-- Blue background retained -->
               <h2 class="font-semibold text-lg text-blue-900 mb-3 flex items-center"> <!-- Darker text and icon alignment -->
