                        ...
                        <form method="POST" id="add-student-form">
                           ...
                           <div class="grid gap-6 mb-6 md:grid-cols-4">
                              ...
                              <div>
                                 ...
                                 <input type="text" id="rfid_serial_number" name="rfid_serial_number" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" autocomplete="off" placeholder="0000000000" />
                              </div>
                              <div>
