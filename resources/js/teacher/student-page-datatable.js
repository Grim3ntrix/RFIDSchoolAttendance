...
export function initializeStudentDatatable() {
    ...
    if (tableLoader) {
        ...
        .then(response => {
            ...
            if (students.length > 0) {
                const tableHTML = `
                    <table id="studentTable" class="bg-gray-50 dark:bg-gray-800">
                        <thead>
                            <tr>
                                <th>
                ...
                document.getElementById('student-datatable-container').innerHTML = tableHTML;
                ...
                students.forEach(student => {
                    ...
                    row.innerHTML = `
                        ...
                        <td>
                            <button type="button" data-modal-target="edit-student-modal" data-modal-toggle="edit-student-modal" class="text-blue-500 hover:underline" data-student-id="${student.id}">
                            ...
                            <button type="button" data-modal-target="delete-student-modal" data-modal-toggle="delete-student-modal" class="text-red-500 hover:underline" data-student-id="${student.id}">
    ...
    const editStudentModal = `
        <div id="edit-student-modal" tabindex="-1" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
            <div class="relative w-full max-w-4xl max-h-full">
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                        ...
                        <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-full text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="edit-student-modal">
                    ...
                    <form id="edit-student-form">
                        <div class="grid gap-6 mb-6 md:grid-cols-4">
                            <div>
                                ...
                                <input type="text" id="edit_school_id" name="school_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" autocomplete="off" placeholder="Enter School ID" />
                            </div>
                            <div>
                                <label for="rfid_serial_number" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">RFID Serial Number</label>
                                <input type="text" id="edit_rfid_serial_number" name="rfid_serial_number" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" autocomplete="off" placeholder="0000000000" />
                            </div>
                            <div>
                                <label for="batch" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Batch</label>
                                <input type="text" id="edit_batch" name="batch" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" autocomplete="off" placeholder="Enter Batch" />
                            </div>
                            <div>
    ...
    if (deleteStudentModalContainer) {
        let studentId; // To hold the ID of the section to delete
                    ...
                    <div id="delete-student-modal" tabindex="-1" class="overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 flex justify-center items-center w-full h-full">
                        <div class="relative p-6 w-full max-w-md max-h-full">
                            <div class="relative bg-white rounded-lg shadow-lg dark:bg-gray-700">
                                <button type="button" class="absolute top-3 right-3 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-full text-sm w-8 h-8 flex justify-center items-center" data-modal-hide="delete-student-modal">
                                ...
                                <div class="p-6 text-center">
                                    ...
                                    <div class="flex justify-center space-x-3">
                                        ...
                                        <button id="delete-student-cancel-btn" data-modal-hide="delete-student-modal" type="button" class="px-5 py-2.5 text-sm font-medium text-gray-900 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 dark:hover:bg-gray-700">
                                            No, Cancel
                                        </button>
                                    </div>
                                </div>
